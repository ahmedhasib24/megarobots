// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersIceShaderSpecularModelsTranslucency' to new syntax.

Shader "NatureManufacture Shaders/Ice Shader Specular Models Translucency"
{
	Properties
	{
		[Header(Translucency)]
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersIceShaderSpecularModelsTranslucency)
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SpecularPower)
#define _SpecularPower_arr NatureManufactureShadersIceShaderSpecularModelsTranslucency
			UNITY_DEFINE_INSTANCED_PROP(fixed, _Smoothness)
#define _Smoothness_arr NatureManufactureShadersIceShaderSpecularModelsTranslucency
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersIceShaderSpecularModelsTranslucency)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecularCustom o )
		{
			...
			fixed3 temp_cast_4 = (_SpecularPower_Instance).xxx;
