// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersIceShaderMetalicModelsTranslucency' to new syntax.

Shader "NatureManufacture Shaders/Ice Shader Metalic Models Translucency"
{
	Properties
	{
		[Header(Translucency)]
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersIceShaderMetalicModelsTranslucency)
			UNITY_DEFINE_INSTANCED_PROP(fixed, _MetalicPower)
#define _MetalicPower_arr NatureManufactureShadersIceShaderMetalicModelsTranslucency
			UNITY_DEFINE_INSTANCED_PROP(fixed, _Smoothness)
#define _Smoothness_arr NatureManufactureShadersIceShaderMetalicModelsTranslucency
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersIceShaderMetalicModelsTranslucency)
