// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersIceShaderSpecularModels' to new syntax.

Shader "NatureManufacture Shaders/Ice Shader Specular Models"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersIceShaderSpecularModels)
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SpecularPower)
#define _SpecularPower_arr NatureManufactureShadersIceShaderSpecularModels
			UNITY_DEFINE_INSTANCED_PROP(fixed, _Smoothness)
#define _Smoothness_arr NatureManufactureShadersIceShaderSpecularModels
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersIceShaderSpecularModels)
