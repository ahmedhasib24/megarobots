// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersIceShaderSpecularLakeTranslucency' to new syntax.

Shader "NatureManufacture Shaders/Ice Shader Specular Lake Translucency"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersIceShaderSpecularLakeTranslucency)
			UNITY_DEFINE_INSTANCED_PROP(fixed4, _RefractionColor)
#define _RefractionColor_arr NatureManufactureShadersIceShaderSpecularLakeTranslucency
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SpecularPower)
#define _SpecularPower_arr NatureManufactureShadersIceShaderSpecularLakeTranslucency
			UNITY_DEFINE_INSTANCED_PROP(fixed, _Smoothness)
#define _Smoothness_arr NatureManufactureShadersIceShaderSpecularLakeTranslucency
			UNITY_DEFINE_INSTANCED_PROP(fixed, _IceAmountOpacity)
#define _IceAmountOpacity_arr NatureManufactureShadersIceShaderSpecularLakeTranslucency
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersIceShaderSpecularLakeTranslucency)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecularCustom o )
		{
			...
			fixed3 temp_cast_5 = (_SpecularPower_Instance).xxx;
			...
			o.Translucency = lerpResult279.rgb;
