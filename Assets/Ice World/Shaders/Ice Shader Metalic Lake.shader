// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersIceShaderMetalicLake' to new syntax.

Shader "NatureManufacture Shaders/Ice Shader Metalic Lake"
{
	Properties
	{
		...
		_Smothness("Smothness", Range( 0 , 2)) = 0.85
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersIceShaderMetalicLake)
			UNITY_DEFINE_INSTANCED_PROP(fixed4, _RefractionColor)
#define _RefractionColor_arr NatureManufactureShadersIceShaderMetalicLake
			UNITY_DEFINE_INSTANCED_PROP(fixed, _MetalicPower)
#define _MetalicPower_arr NatureManufactureShadersIceShaderMetalicLake
			UNITY_DEFINE_INSTANCED_PROP(fixed, _Smothness)
#define _Smothness_arr NatureManufactureShadersIceShaderMetalicLake
			UNITY_DEFINE_INSTANCED_PROP(fixed, _IceAmountOpacity)
#define _IceAmountOpacity_arr NatureManufactureShadersIceShaderMetalicLake
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersIceShaderMetalicLake)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			fixed _Smothness_Instance = UNITY_ACCESS_INSTANCED_PROP(_Smothness_arr, _Smothness);
			o.Smoothness = _Smothness_Instance;
